...
%\setlength{\abovecaptionskip}{0.8pt}
  ...
  \tabcolsep6pt
  %\arrayrulewidth1pt
  \caption{Comparison of related work.}\label{tab:related_work}
  \renewcommand{\multirowsetup}{\centering}
  \noindent\makebox[\textwidth]{%
        \begin{tabularx}{1.0\textwidth}{|c|c|c|c|c|c|c|c|}
        \cline{1-8}
        \multicolumn{1}{|c|}{\multirow{2}*{\textbf{\footnotesize System}}}
        &\multicolumn{7}{c|}{\textbf{ \footnotesize Advantages}} \\
         \cline{2-8}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize High Accuracy}}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize Practicality }}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize Convenience}}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize Economical}}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize Information Richness }}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize Understandability}}
    &  \multicolumn{1}{c|}{\textbf{ \footnotesize Guidance}} \\
        \cline{1-8}
        \multirow{4}{2.35cm}  {\textbf{SleepGuard\\Medical technology\\Smartphone\\Wearable device}}
