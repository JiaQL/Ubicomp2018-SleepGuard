...
\begin{itemize}
  ...
  \textcolor{cyan}{\item \textbf{Limitations of single wrist sensor.} In our paper, we only use the sensor data in the left-hand smart
  watch. Although movement patterns of the left and right wrist are different during sleep, the technique used for detecting sleep
