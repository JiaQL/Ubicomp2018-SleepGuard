...
\begin{itemize}
  ...
  \textcolor{cyan}{\item \textbf{Limitations of single wrist sensor.} 
  ...
  \textcolor{cyan} {\item \textbf{Comparing to Fitbit.} In addition, when we use Fitbit as groundtruth, Fitbit is worn on a different
  ...
  \textcolor{cyan}{\item \textbf{Multiple-sleeper scenario.} Currently, {\systemname} considers that the user is sleeping alone, but
  ...
  \textcolor{cyan}{\item \textbf{An occurrence probability of unusual arm's positions.} We detect sleep posture based on arm's positions
